            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('categorie.create')}}" class="btn btn-success btn-sm" role="button"
                                        ...
                                        @foreach($categories as $categorie)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('categorie.edit',$categorie->id)}}" class="btn btn-info btn-sm" title="Edit" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                                    <a href="{{route('categorie.show',$categorie->id)}}" class="btn btn-info btn-sm" title="Show" role="button" aria-pressed="true"><i class="fa fa-book"></i></a>
