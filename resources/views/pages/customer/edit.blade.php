                ...
                <form method="post" action="{{ route('customer.update',$customer->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" name="adders" value="{{ $customer->address }}" class="form-control">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">
                                <input type="password" id="password" class="form-control" name="password" value="{{ $customer->password }}">
                            </p><br><br>
