                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('countries.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">Create New country</a><br><br>
                                        ...
                                        @foreach($countries as $countrie)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('countries.edit',$countrie->id)}}" class="btn btn-info btn-sm" title="Edit" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                                    <a href="{{route('countries.show',$countrie->id)}}" class="btn btn-info btn-sm" title="Show" role="button" aria-pressed="true"><i class="fa fa-book"></i></a>
