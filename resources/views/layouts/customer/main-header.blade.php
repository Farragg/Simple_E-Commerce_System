        ...
        <li class="nav-item dropdown ">
            <a class="nav-link top-nav" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
               aria-expanded="false">
                <i class="ti-bell"></i>
                <span
                    class="badge badge-danger notification-status">{{ auth('customer')->user()->unreadNotifications->count() }} </span>
            </a>
            @foreach (auth('customer')->user()->unreadNotifications as $notification )
                <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                    ...
                    <a href="#" class="dropdown-item">{{$notification->data['create_order'] }}<small
                            class="float-right text-muted time">{{ $notification->created_at->format('d-m-Y') }}</small>
                    </a>
                    <a href="#" class="dropdown-item">New invoice received<small
                            class="float-right text-muted time">{{ $notification->created_at->format('s') }}mint</small>
                    </a>
